...
import Badge from '../Components/Badge'; // Import your Badge component
...
describe('Badge Component', () => {
    ...
    test.each([
        ...
        const { getByText } = render(<Badge type={badgeType as "primary" | "secondary" | "transparent" | "outline"} label="Type Test" />);
        const badgeElement = getByText(/Type Test/i);
        expect(badgeElement).toHaveStyle({ backgroundColor: expect.stringMatching(expectedColor) });
