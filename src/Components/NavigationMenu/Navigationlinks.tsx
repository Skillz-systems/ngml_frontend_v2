...
export const Navigationlinks = [
  ...
  { id: 3, name: 'Profile', to: '/customer/customerprofilepage', icon: profileicon, type: 'primary' },
  {
    id: 4, name: 'Settings', to: '/customer/customersettingspage', icon: Settingsicon, type: 'secondary', subMenu: [
      { id: 1, name: 'Business', to: '/customer/customerbusinesspage', icon: Businessicon },
      { id: 2, name: 'Business', to: '/customer/customerbusinesspage', icon: Businessicon },
      { id: 3, name: 'Business', to: '/customer/customerbusinesspage', icon: Businessicon }
    ]
  },
