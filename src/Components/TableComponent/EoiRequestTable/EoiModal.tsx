...
const EoiModal: React.FC<EoiModalprops> = ({
    ...
    return (
        <div
            ...
            <div className='h-[454px] bg-[#FFFFFF] flex items-center justify-center '>
                <div className='border border-[#E2E4EB] w-[726px] h-[430px] rounded-[12px] p-[20px] pt-[10px] flex flex-col gap-y-[10px]'>
            ...
            <div className='h-[48px] p-[20px] bg-[#FFF3D5] '>
