...
//                     if (field.type === 'file' && customerData[`${field.name}`] instanceof File) {
//                         try {
//                             console.log(`Attempting to convert file: ${field.name}`, customerData[`${field.name}`]);
//                             const base64File = await convertFileToBase64(
//                                 customerData[`${field.name}`] as File
//                             );
...
//                             // Handle the error as needed, perhaps by setting a default value or skipping this field
//                             return null;
//                         }
//                     } else {
//                         return {
