...
// import { convertFileToBase64 } from '@/Utils/base64Converter';
// import { areRequiredFieldsFilled, TouchedFields, updateTouchedFields } from '@/Utils/formValidation';
// import React, { Fragment, useEffect, useState } from 'react';
// import { useLocation, useNavigate } from 'react-router-dom';
// import { Button, CustomerListTable, Heading, Modal, StatisticRectangleCard } from '../../Components/index';
...
//     const { data, isSuccess, isLoading } = useGetFormByIdQuery(27);
//     const [submitForm, { isLoading: submitLoading, isSuccess: submitSuccess }] = useSubmitFormMutation();
...
//     const handleChange = (field: string, value: string | File | null) => {
//         setCustomerData(prev => ({ ...prev, [field]: value }));
//         setTouchedFields(prev => updateTouchedFields(field, prev));
//     };

//     const handleCreateCustomer = async () => {
//         const { isValid, invalidFields: newInvalidFields } = areRequiredFieldsFilled(customerForm, customerData, touchedFields);
...
//                                 maxSizeMB={10}
//                                 allowedFileTypes={[FileType.PDF]}
//                                 error={invalidFields.includes(form.name ?? '') ? 'This field is required' : ''}
//                             />
//                         </Fragment>
//                     ))
//                 ) : (
