...
import DailyVolumeHistoryTable from '@/Components/TableComponent/DailyVolumnHistoryTable/DailyVolumnHistoryTable';
...
const CustomerDailyVolumns: React.FC = () => {
    ...
    // const { data: dailyvolumes, isSuccess: dailyvolumesSuccess } = useGetFormByNameQuery(Number(customerId), {
    //     skip: !customerId
    // });
    ...
    return (
        <div className="w-full h-full">
            <div className="w-100% h-full p-8 bg-[#FFFFFF] bg-opacity-50 rounded-lg flex-col justify-start items-start gap-8 flex">
                ...
                <DailyVolumeHistoryTable customerId={customerId} customerSiteId={customerSiteId} />
                </div>
            </div>
            <div>
                <Modal
