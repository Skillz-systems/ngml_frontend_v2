...
const SiteVisitationPage = () => {
    ...
    useEffect(() => {
        if ( data ) {
            ...
            setSiteVisitFields(updatedFields);
                        ...
                        siteVisitFields.map(field => (
                            <Fragment key={field.id}>
                                <CustomInput
                                    ...
                                    label={field.name}
                                    value={siteVisitData[field.key as keyof typeof siteVisitData]}
                                    handleChangeEvent={(value) => handleInputChange(value, field.key as keyof typeof siteVisitData)}
