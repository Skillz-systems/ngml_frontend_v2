...
//               <p className="text-center text-[8px] md:text-[12px] text-[rgba(5, 5, 5, 1)]">
...
import ActionModal from '@/Components/ActionModal/ActionModal'; // Adjust the import path as needed
...
const ExampleComponent = () => {
    ...
    return (
        <div>
            ...
            >
                {/* Any additional content can be passed here */}
            </ActionModal>
        </div>
    );
};
