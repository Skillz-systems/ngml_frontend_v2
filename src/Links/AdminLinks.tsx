...
export const AdminLinks = [
  ...
  },
  {
    ...
    type: 'secondary',
    subMenu: [
      { id: 1, name: 'Customers', to: '/admin/records/customer', icon: images.Customericon, type: 'primary' },
      { id: 2, name: 'Suppliers', to: '/admin/records/suppliers', icon: images.Suppliericon, type: 'primary' },
      ...
      { id: 5, name: 'Connect Projects', to: '/admin/records/connectprojectpage', icon: images.Invoiceicon, type: 'primary' },
      { id: 6, name: 'Bids', to: '/admin/records/bidspage', icon: images.Bidicon, type: 'primary' }
